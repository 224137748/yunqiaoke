<template>
  ...
  <div class="eMutual">
    ...
    <!-- <head-nav :title="'互助金收支明细'" class="mheader"></head-nav> -->
    <div class="eMutual-box">
      <div class="eMutual-item">
        <div class="eMutual-title">{{current_battery}}<span>盎司</span></div>
        <div class="eMutual-bd">互助金余额</div>
        <i class="eMutual-i1"></i>
      </div>
      <div class="eMutual-item">
        <div class="eMutual-title">{{total_battery}}<span>盎司</span></div>
        <div class="eMutual-bd">互助金总收入</div>
    ...
    <div class="eMutual-int" v-for="(item,i) in list" :key="i">
      ...
      <div class="eMutual-flex" v-for="(em,index) in item.content" :key="index">
        ...
        <div class="eMutual-right" v-if="em.type === 2">+{{em.battery}}盎司</div>
        <div class="eMutual-right" v-else>-{{em.battery}}盎司</div>
      </div>
    </div>
    ...
    <btn :vals="'赚取互助金'" class="btn" @btnClick="getGo"></btn>
  </div>
</template>
...
import { getCourseBattery } from "../../../api/home.js";
export default {
  components: {
    // headNav
    btn
